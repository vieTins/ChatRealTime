...
public class ProgressCircleUI extends BasicProgressBarUI {
    ...
    public ProgressCircleUI(Progress pro) {
        this.pro = pro;
        imageDown = new ImageIcon(getClass().getResource("/ChatIcon/down.png")).getImage();
        imageCancel = new ImageIcon(getClass().getResource("/ChatIcon/cancel.png")).getImage();
        imageFile = new ImageIcon(getClass().getResource("/ChatIcon/file.png")).getImage();
    }
